...
class Config:
    ...
    MACHINES = ['localhost:10007', # MACHINE 0
                'localhost:20007', # MACHINE 1
                'localhost:30007'] # MACHINE 2
    STREAMS = [
        # [ADDRESS, CHANNELS]
        ["localhost:10107", [0]], # [0, 3]], # MACHINE 0
        ["localhost:20107", [0]], # [1, 3]], # MACHINE 1
        ["localhost:30107", [0]], # [2, 3]], # MACHINE 2
    ]
